...
appControllers.controller('expenseDashboardCtrl', function ($scope, $state, $timeout, $ionicHistory, $mdBottomSheet, $stateParams, $cordovaOauth, $http, localStorage, $mdToast) {
